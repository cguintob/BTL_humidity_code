...
''' ================================================================================================================== '''
''' ========================================= PART 2: KEYBOARD FUNCTIONALITY ========================================= '''
''' ================================================================================================================== '''

''' This part of my code was almost definitely unnecessary, but I made the 
program such that when the user hits the "alt" button, data collection stops. 
The way I did this was defining this function "wait()," which uses the keyboard 
module to listen to the keyboard and see if a key was pressed. If the "alt" key 
is pressed, it will return False; if it isn't, it will return True. The function
 is continuously called in a while loop, so when the "alt" key is pressed, the 
while loop will stop running because False will have been returned. '''
...
''' ================================================================================================================== '''
''' ====================================== PART 3: FETCHING DATA FROM WEBSITES ======================================= '''
''' ================================================================================================================== '''
                ...
                try:
                    ...
                    # This writes the temperature to the data file.
                        ...
                        try:
                            ...
                            print("Raising a requests.exceptions.ConnectionError")
                            weather_data.write("\n")
                            time.sleep(20)
                        weather_data.write("\n")
                        weather_data.close()
...
continuously opening and closing the file, we save the data, preventing it from 
being lost. '''
