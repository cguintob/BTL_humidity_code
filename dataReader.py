...
file gives us the data from wttr. '''
file1 = sys.argv[1]
file2 = sys.argv[2]
...
ax1.plot(weather_data_points, weather_data_hums, marker = "+", c = "g")
...
ax1.plot([0, len(index)], [40, 40], c = "r", linewidth = 3.0)
ax1.plot([0, len(index)], [60, 60], c = "r", linewidth = 3.0)
hum.show()
...
plt.plot(weather_data_points, weather_data_temps, marker = "+", c = "r")
temp.show()
